      ...
      <MiniGallery>
        ...
        {images.map((image, index) => {
          if (image.url === null & image.thumbnail_url === null) {
            return <img src="https://st.depositphotos.com/3097111/4720/v/600/depositphotos_47208689-stock-illustration-picture-coming-soon-image-vector.jpg" alt="Thumbnail Image" key={index} className="MiniGalleryImage" onClick={() => {props.setImageIndex(index)}}/>
          }
