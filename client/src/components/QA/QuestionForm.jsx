...
const QuestionForm = ({updateData}) => {
  ...
  const handleSubmit = (e) => {
    ...
    const questionFormRequest = {product_id: productId, body: body.value, name: name.value, email: email.value};
    ...
    <div className="form-wrapper">
      <div className='question-form-container'>
        <form onSubmit={handleSubmit} className='question-form'>
          ...
          <h3>About the "{currentProduct.name}"</h3>
